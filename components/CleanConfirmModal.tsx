...
export const CleanConfirmModal: React.FC<CleanConfirmModalProps> = ({ onClose, onConfirm, cost, zenPoints }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <div className="relative bg-gray-900 border border-gray-700 p-6 rounded-2xl w-full max-w-sm shadow-2xl animate-fade-in glass-panel">
                <button
                    onClick={onClose}
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <div className="bg-gray-800/50 rounded-lg p-3 w-full border border-gray-700 mt-2 glass-section">
                        <div className="flex justify-between items-center text-sm">
                            <span className="text-gray-400">보유 ZP</span>
                            <span className="font-bold text-yellow-300">{zenPoints.toLocaleString()} ZP</span>
                        </div>
